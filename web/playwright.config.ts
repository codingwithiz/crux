...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "unit",
      testMatch: /(auth-gate|calibration|local-state|citations|env-secret|parse-input|pdf-export|cost|rank|retry|revise|routing|ssrf|topic-sources)\.spec\.ts/,
      use: {},
    },
    {
      name: "browser",
      testIgnore: /(auth-gate|calibration|local-state|citations|env-secret|parse-input|pdf-export|cost|rank|retry|revise|routing|ssrf|topic-sources)\.spec\.ts/,
