...
export default defineConfig({
  ...
  projects: [
    ...
    {
      name: "unit",
      testMatch: /(auth-gate|local-state|citations|env-secret|parse-input|pdf-export|cost|rank|retry|revise|routing|ssrf|topic-sources)\.spec\.ts/,
      use: {},
    },
    {
      name: "browser",
      testIgnore: /(auth-gate|local-state|citations|env-secret|parse-input|pdf-export|cost|rank|retry|revise|routing|ssrf|topic-sources)\.spec\.ts/,
